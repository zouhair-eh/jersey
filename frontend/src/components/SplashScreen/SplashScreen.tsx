...
export default function SplashScreen() {
  ...
  useEffect(() => {
    ...
    const removeTimer = setTimeout(() => setVisible(false), 6100);
    return () => {
    ...
    <>
      ...
      <div
        style={{
          ...
          background:     `
            linear-gradient(217deg, rgba(0,255,135,0.18), rgba(0,255,135,0) 70%),
            linear-gradient(127deg, rgba(255,61,61,0.15),  rgba(255,61,61,0)  65%),
            linear-gradient(336deg, rgba(200,168,75,0.18), rgba(200,168,75,0) 70%),
            #0A0A0F
          `,
